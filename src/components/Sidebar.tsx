...
const SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { key: "dashboard", label: "Dashboard", eyebrow: "Your portfolio", icon: User2 },
  { key: "swap-pro", label: "Swap Pro", eyebrow: "Best rates", icon: Zap },
  { key: "swap", label: "Swap", eyebrow: "Trade tokens", icon: ArrowRightLeft },
  { key: "bridge", label: "Bridge", eyebrow: "Cross-chain", icon: Link2 },
